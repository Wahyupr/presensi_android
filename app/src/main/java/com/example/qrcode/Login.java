...
public class Login extends AppCompatActivity {
    ...
    public final static String TAG_USERNAME = "nis";
    ...
    String id, username,nama,nama_sekolah,jurusan,qrcode,myip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nama_sekolah = sharedpreferences.getString(TAG_NAMA_SEKOLAH, null);
        ...
        if (session) {
            ...
            intent.putExtra(TAG_NAMA_SEKOLAH, nama_sekolah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        String nama_sekolah = jObj.getString(TAG_NAMA_SEKOLAH);
                        ...
                        editor.putString(TAG_NAMA_SEKOLAH, nama_sekolah);
