...
public class Izin extends AppCompatActivity {
    ...
    private static final String TAG = Izin.class.getSimpleName();
    ...
    private String UPLOAD_URL = "http://192.168.100.14/foto/upload.php";

    private static final String TAG_SUCCESS = "success";
    private static final String TAG_MESSAGE = "message";
    private String KEY_IMAGE = "image";
    private String KEY_NAME = "alasan";
    private String KEY_USER = "id_user";
    private String KEY_IP = "ip_address";

    String tag_json_obj = "json_obj_req";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ijin);
        ...
        user = (EditText) findViewById(R.id.user);
         myip=(EditText) findViewById(R.id.txt_ip);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(Izin.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //menampilkan toast
                        Toast.makeText(Izin.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put( KEY_USER, user.getText().toString().trim());
                params.put( KEY_IP, myip.getText().toString().trim());
